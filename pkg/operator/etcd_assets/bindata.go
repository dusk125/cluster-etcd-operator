...
var _etcdEtcdBackupYaml = []byte(`apiVersion: etcdbackups.operator.openshift.io/v1alpha1
kind: EtcdBackup
spec:
  pvcName: "template"`)

func etcdEtcdBackupYamlBytes() ([]byte, error) {
	return _etcdEtcdBackupYaml, nil
}

func etcdEtcdBackupYaml() (*asset, error) {
	bytes, err := etcdEtcdBackupYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "etcd/etcd-backup.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"etcd/etcd-backup.yaml":        etcdEtcdBackupYaml,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"etcd": {nil, map[string]*bintree{
		...
		"etcd-backup.yaml":        {etcdEtcdBackupYaml, map[string]*bintree{}},
